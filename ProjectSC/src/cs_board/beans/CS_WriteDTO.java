...
public class CS_WriteDTO {
	...
	public CS_WriteDTO(int uid, String subject, String content,String mem_id, int mem_uid) {
		super();
		this.uid = uid;
		this.subject = subject;
		this.content = content;
	...
	public CS_WriteDTO(int uid, String subject, String content, String regDate, int mem_uid, String mem_id) {
		super();
		this.uid = uid;
		this.subject = subject;
		this.content = content;
