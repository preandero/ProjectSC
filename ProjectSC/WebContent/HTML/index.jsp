...
<body>
    ...
    <section id="video_banner">
        <div id="main">
            <!-- <span><b>Asangbinsi Pos Service</b></span> -->
            <video playsinline autoplay muted loop poster="https://nrsplus.com/ext/bg-still.jpg" id="bgvideo" width="x" height="y">
                <source src="https://nrsplus.com/ext/hero-banner-EDITED.mp4" type="video/mp4">
            </video>
            <div class="vid-text">

                <!-- <span><b>Asangbinsi Pos Service</b></span> -->
                <h1 class="vid-h1">Asangbinsi Pos Service</h1>
                ...
                <h2 class="vid-h3">스마트폰이나 태블릿을 편리한 POS 기기로 사용해보세요. 재고와 판매관리 및 직원 관리, 고객 관리 및 매출 증대를 도와드립니다. 매장이 몇 개가 있든
                    ...
                    <div class="vid-txt-1">
                        ...
                        <a class="button" onclick="location.href='about_us.html'">
                            <span class="away">비회원이신가요?</span>
                            <span class="over">새로운 계정을 생성해보세요</span>
                        </a>
                    </div>
    ...
    <!--div class="foot"-->
    <div class="language">
        <div class="lan"> © 2020 ASANGBINSI COMPANY Inc, All Rights Reserved<br> </div> 
            <!-- <div class="lan2">상호명 : Asangbinsi 대표자명 : 아상빈씨TEAM 사업자등록번호 : 123-456-7891</div> -->
    </div>
